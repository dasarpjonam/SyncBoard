...
import { LayoutDashboard, Settings, FolderOpen, Plus } from 'lucide-react';
    ...
    <div className="w-64 bg-gray-900 text-white flex flex-col h-full">
      ...
      <div className="p-4 border-t border-gray-800 flex flex-col gap-2">
        <button
          ...
          className="flex items-center gap-2 p-2 w-full rounded hover:bg-gray-800 text-left text-sm text-green-400 font-medium"
        >
          <Plus size={20} />
          New Workspace
        </button>
